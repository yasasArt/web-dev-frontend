    ...
    return (
        <>
            ...
            >
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* Notes */}
                        ...
                        <div>
                            ...
                            <textarea className="bg-primary p-3 rounded-lg text-sm w-full"
                             value ={notes} 
                             onChange = {(e) =>
                             {
                                if(e.target.value ==""){
                ...
                {/* Footer */}
                <div className="border-t p-5 gap-2 flex justify-between items-center">
...
function InfoItem({ label, value, badge }) {
    return (
        <div>
            ...
            {badge ? (
                <span className="inline-block mt-1 px-3 py-1 text-xs rounded-full bg-blue-100 text-blue-700 capitalize">
                    {value}
                </span>
            ) : (
